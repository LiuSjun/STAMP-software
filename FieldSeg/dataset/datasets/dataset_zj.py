...
PATH_IMAGE_ROOT = r"G:\FinalsForData\GF2\ZJ\Processed\Training"
PATH_IMAGES_SPEC = [os.path.join(PATH_IMAGE_ROOT, "Sub{}.tif".format(i)) for i in range(3)]
PATH_IMAGES_LABEL = ["Sub0_Area.tif", "Sub1_Area.dat", "Sub2_label.dat", "Sub3_Area", "Sub4_Area"]
PATH_IMAGES_LABEL = [os.path.join(PATH_IMAGE_ROOT, PATH_IMAGES_LABEL[i]) for i in range(5)]
