...
PATH_IMAGE_ROOT = r"G:\FinalsForData\GF2\HLJ\Proccesed\Training"
PATH_IMAGES_SPEC = [os.path.join(PATH_IMAGE_ROOT, "GF2_20170731_Subset1.dat")]
PATH_IMAGES_LABEL = [os.path.join(PATH_IMAGE_ROOT, "Subset1_Label.dat")]
