...
if __name__ == "__main__":
    ...
    # predict_subimg()
    img_target_path = r"E:\Newsegdataset\sichuan\yuce"
    ...
    for k in range(len(image_list)):
        if image_list[k][-4:] == '.tif':
            ...
            name_ptn = os.path.join(ROOT_PTN, "resnet1227_seg_0.9692617136499156.pth")   #resnet1208_seg_6datasets_0.8858911735670907"resnet1208_seg_6datasets_0.8858911735670907.pth"
            ...
            name_ptn = os.path.join(ROOT_PTN, "resnet_bou_0.6463043689727783.pth") #resnet1215_bou_0.5788623491923014.pth")  # resnet1208_bou_6datasets_0.56199397785323.pth
            ...
            UNIT.numpy2img(os.path.join(ROOT_RST, "{}_result.tif".format(image_list[k][:-4])), img_seg, proj=proj, geot=geot)  #
            del img_seg   #, rgb
