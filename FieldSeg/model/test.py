...
TS_ROOT = r"D:\CropSegmentation\tensorboard"
...
def ts_file_reader(root, metric, dts):
    ...
    '''
    tra_even_root = os.path.join(root, "{}_{}".format(dts, metric))
...
if __name__ == "__main__":
    ...
    model_a_file = 'RGB_UNET_4a_DW'
    model_b_file = 'RGB_UNET_4a_NO_DW'
    model_a_name = 'resnet34 aug'
    model_b_name = 'resnet50 aug'

    comp_f1_ac(model_a_file, model_b_file, model_a_name, model_b_name)