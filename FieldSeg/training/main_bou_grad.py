...
from model.resnet_unet_bou_grad import UNet_Bou as BasicUNet
...
def tranining(dataset_tra, dataset_val, dataset_tst, bestpth):
    ...
    # )
    writer = sw(r'G:\FinalsForData\tensorboard\reuet_bou_grad', filename_suffix='0905')
    ptn_name = "resnet_bou_grad_{}.pth"
    batch_size = 10
