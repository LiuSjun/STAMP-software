'''
该函数为LOSS更改后的MODEL_RGB,该函数只用RGB进行训练
...
def tranining():
    ...
    # )
    writer = sw(r'D:\CropSegmentation\tensorboard', filename_suffix='0906')
    ...
    model = RGBUNet().cuda()
    loss_fn = util_mod.LovaszSoftmaxV1()  # loss_fn = nn.CrossEntropyLoss()
