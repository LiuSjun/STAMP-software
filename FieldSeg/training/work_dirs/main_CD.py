...
def tranining():
    ...
    # )
    val_percent = 0.1
    writer = sw(r'D:\CropSegmentation\tensorboard\HRNET', filename_suffix='0907')
    ...
    dataset_extent = DatasetSegtask(A_dir, B_dir,Label_dir)
    ...
    trainloader = torch.utils.data.DataLoader(train_dataset_extent, batch_size=7, shuffle=True, num_workers=0)
    valloader = torch.utils.data.DataLoader(val_dataset_extent, batch_size=7, shuffle=True, num_workers=0)
