...
from model.resnet_unet_rgb_dropout import UNet as RGBUNet
...
logdir = r'D:\CropSegmentation\tensorboard\RGB_UNET_Dropout'
...
def tranining():
    ...
    # )
    writer = sw(logdir, filename_suffix='0907')
    ...
    testloader = DataLoader(DatasetT(), batch_size=batch_size, shuffle=True, num_workers=0)
